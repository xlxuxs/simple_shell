This repository contains the implementation of a simple shell program from the team project of 0x16. C - Simple Shell form ALX Africa. The following tasks have been completed by the authors:
